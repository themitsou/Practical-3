...
import gr.academic.city.sdmd.projectissues.ui.activity.fragments.BlankFragment;
import gr.academic.city.sdmd.projectissues.ui.activity.fragments.ClubActivitiesFragment;
import gr.academic.city.sdmd.projectissues.ui.activity.fragments.ClubActivityDetailsFragment;
...
public class ClubActivitiesActivity extends ToolbarActivity implements ClubActivitiesFragment.OnListFragmentInteractionListener, ClubActivityDetailsFragment.OnFragmentInteractionListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == DELETE_REQUEST) {
            if (resultCode == RESULT_OK) {
                ...
                ProjectIssueService.startDeleteActivity(ClubActivitiesActivity.this, deleteActivityID);
                ...
                Snackbar.make(findViewById(R.id.coordinator_layout), R.string.msg_snackbar, Snackbar.LENGTH_LONG).setCallback(new Snackbar.Callback() {
                    ...
                    public void onClick(View v) {
                        ProjectIssueService.startUnDeleteActivity(ClubActivitiesActivity.this, deleteActivityID);
                    }
                }).show();
    ...
    public void onClubActivityDeleted(final Long activity) {
        ProjectIssueService.startDeleteActivity(ClubActivitiesActivity.this, activity);
        FragmentManager fragmentManager = getSupportFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        ...
        Snackbar.make(findViewById(R.id.coordinator_layout), R.string.msg_snackbar, Snackbar.LENGTH_LONG).setCallback(new Snackbar.Callback() {
            ...
            @Override
            public void onClick(View v) {
                ProjectIssueService.startUnDeleteActivity(ClubActivitiesActivity.this, activity);
            }
        }).show();
    }
}
