...
public class PushToServerService extends IntentService {
    ...
    private void pushActivitiesToServer() {
        ...
        while (cursor.moveToNext()) {
            ...
            executeRequest(MessageFormat.format(Constants.CLUB_ACTIVITIES_URL, clubServerId), Commons.ConnectionMethod.POST, new Gson().toJson(new ClubActivity(title, shortNote, longNote, timestamp, clubServerId)), new Commons.ResponseCallback() {
                @Override
